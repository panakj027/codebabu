  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div
        ...
        aria-hidden="true"
      />
      <Container className="relative grid items-center gap-10 py-12 sm:gap-12 sm:py-16 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:gap-10 lg:py-20">
        <div className="min-w-0">
          <p className="mb-4 text-xs font-semibold uppercase tracking-[0.22em] text-accent-soft">
            IT development studio
          </p>
          <h1 className="font-display text-[2rem] font-semibold leading-tight tracking-tight text-balance sm:text-5xl lg:text-[3.4rem] lg:leading-[1.12]">
          ...
          <p className="mt-6 max-w-xl text-base leading-relaxed text-muted sm:text-lg">
            ...
            engaging digital products through modern web development, mobile apps,
            software solutions, UI/UX design, and AI technologies.
          </p>
